...
def initialize_rag():
    ...
    llm=ChatGoogleGenerativeAI(model=GENERATION_MODEL,
        ...
        # print(documents)
        # if not documents:
        #     raise ValueError("No chunks retreived")
            ...
            (
                "system",
                        """ You are an Assistant.
                            ...
                            4.Should strictly return the answer in a valid JSON format as the example given below.
                            5.The actual user question tio be answered will be at the bottom
